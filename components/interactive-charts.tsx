// src/components/interactive-charts.tsx
/**
 * This file, interactive-charts.tsx, defines an interactive chart component based on React and ECharts.
 *
 * Main Features:
 * - Chart Rendering: Renders interactive charts (line, scatter, bar) using ECharts, with support for light and dark themes.
 * - Dynamic Data: Accepts a chart configuration object to dynamically render different chart types and datasets.
 * - Customizable Appearance: Supports custom colors, axis labels, grid styles, and tooltips, adapting to the current theme.
 * - Responsive & Animated: Uses Framer Motion for smooth entry animations and ensures charts are responsive to container size.
 * - Accessibility: Provides clear labeling and color contrast for better accessibility.
 *
 * Usage Scenarios:
 * This component is suitable for dashboards, analytics pages, or any application that requires dynamic, interactive data visualization.
 * It abstracts away ECharts configuration complexity, making it easy to reuse and integrate in various projects.
 */
