 ...
 * PlaceCard Component
 * 
 * A React component that displays detailed information about a location in a card format.
 * Designed for use in travel apps, map interfaces, or local service applications.
 * 
 * Features:
 * - Displays place image with fallback placeholder
 * - Shows key information: name, opening status, type, rating, reviews, price level
 * - Optional description with text truncation
 * - Action buttons for directions, website, phone call, and TripAdvisor link
 * - Supports different display variants (overlay or list)
 * 
 * The component takes a structured Place object with location details, media,
 * and metadata, offering a comprehensive yet compact UI for location browsing.
 */
