/**
 * Map Components for displaying interactive Mapbox maps in the application.
 *
 * - Provides a MapComponent that renders a Mapbox map centered at a given location,
 *   with optional markers for places of interest.
 * - Supports custom marker rendering, popups, and marker click handling.
 * - Includes MapSkeleton for loading states and MapContainer for a titled map section.
 *
 * Usage:
 *   <MapComponent center={...} places={...} zoom={...} onMarkerClick={...} />
 *   <MapContainer title="..." center={...} places={...} loading={...} />
 */
