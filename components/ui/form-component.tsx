...
const models = [
    ...
    { value: "scira-grok3-mini-fast-beta", label: "Grok 3.0 Mini (Fast)", icon: XAIIcon, iconClass: "!text-neutral-300", description: "xAI's Grok 3.0 Mini Fast model", color: "orange", vision: false, experimental: false, category: "Stable" },
    { value: "scira-grok3-mini-beta", label: "Grok 3.0 Mini", icon: XAIIcon, iconClass: "!text-neutral-900 dark:!text-white", description: "xAI's Grok 3.0 Mini model", color: "purple", vision: false, experimental: true, category: "Experimental" },
];
    ...
    if (isMobile) {
        return (
            <button
                ...
                aria-label={`Select ${group.name}`} // Add accessible label
            >
    ...
    return (
        <div className="flex flex-col w-full">
            ...
            >
                ...
                <input type="file" className="hidden" ref={fileInputRef} multiple onChange={handleFileChange} accept="image/*" tabIndex={-1} aria-label="Attach image file" />
                <input type="file" className="hidden" ref={postSubmitFileInputRef} multiple onChange={handleFileChange} accept="image/*" tabIndex={-1} aria-label="Attach image file after submit" />
